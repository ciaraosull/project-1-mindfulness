...
All features were checked on laptop, mobile (Samsung Galaxy & iPhone 8).  The site was sent to peers to also check from their devices that all features functioned correctly.

Each link in the navagation bar was checked that it related to the section it was suppose to and also that the logo linked back to the home page.
